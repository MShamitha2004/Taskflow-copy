...
# This script helps set up automated notification reminders

echo "Setting up notification system..."

# Create a batch file for Windows Task Scheduler
cat > setup_notifications.bat << 'EOF'
@echo off
...
echo "Created setup_notifications.bat"
echo "Run this batch file as Administrator to set up automated notifications"
echo ""
echo "Manual commands for testing:"
echo "python manage.py send_reminders --hours 24"
echo "python manage.py send_summaries --type daily"
echo "python manage.py send_summaries --type weekly"
